...
I decided to write the C version as a single function, so as to only have to loop over the two
...
And this is again where I'm going to call it a night ;) I'll finish writing this article tomorrow or
